...
var CSPContext = React3.createContext(void 0);
if (true) CSPContext.displayName = "CSPContext";
var DEFAULT_CSP_CONTEXT_VALUE = {
  disableStyleElements: false
};
function useCSPContext() {
  return React3.useContext(CSPContext) ?? DEFAULT_CSP_CONTEXT_VALUE;
}
...
function useCompositeListItem(params = {}) {
  ...
  const indexRef = React4.useRef(-1);
  const [index, setIndex] = React4.useState(externalIndex ?? (indexGuessBehavior === IndexGuessBehavior.GuessFromOrder ? () => {
...
//# sourceMappingURL=chunk-JWR3Y574.js.map
